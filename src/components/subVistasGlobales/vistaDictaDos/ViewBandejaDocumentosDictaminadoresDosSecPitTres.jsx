...
const ViewBandejaDocumentosDictaminadoresDosSecPitTres = () => {
...
const eliminar=async(id)=>{
  ...
  const agregar= async(e)=>{
   ...
   try {        
        ...
        if(await db.collection('endoresoluciondictaminadordossectres').add(nuevo)){
...
export default ViewBandejaDocumentosDictaminadoresDosSecPitTres