...
const ViewBandejaDocumentosDictaminadoresDosSecPitDos = () => {
...
const eliminar=async(id)=>{
  ...
  const agregar= async(e)=>{
   ...
   try {        
        ...
        if(await db.collection('endoresoluciondictaminadordossecdos').add(nuevo)){
...
export default ViewBandejaDocumentosDictaminadoresDosSecPitDos