...
const ViewBandejaDocumentosDictaminadoresTres = () => {
...
const eliminar=async(id)=>{
  ...
  const agregar= async(e)=>{
   ...
   try {        
        ...
        if(await db.collection('endoresoluciondictaminadortres').add(nuevo)){
...
export default ViewBandejaDocumentosDictaminadoresTres