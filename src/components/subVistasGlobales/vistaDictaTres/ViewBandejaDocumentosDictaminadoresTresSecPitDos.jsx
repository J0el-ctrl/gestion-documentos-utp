...
const ViewBandejaDocumentosDictaminadoresTresSecPitDos = () => {
  ...
  useEffect(() =>  {
    const obtenerDatos=async()=>{
        try {
            ...
            const data= await db.collection('endodictaminadoressecpitdos').orderBy('fecha','desc').get()
...
const eliminar=async(id)=>{
  try {
     await  db.collection('endodictaminadoressecpitdos').doc(id).delete()
  ...
  const agregar= async(e)=>{
   ...
   try {        
        ...
        if(await db.collection('endoresoluciondictaminadortressecdos').add(nuevo)){
...
const editar = async (id) => {
    ...
    try {
      ...
      await db.collection('endodictaminadoressecpitdos').doc(id).update({
...
export default ViewBandejaDocumentosDictaminadoresTresSecPitDos