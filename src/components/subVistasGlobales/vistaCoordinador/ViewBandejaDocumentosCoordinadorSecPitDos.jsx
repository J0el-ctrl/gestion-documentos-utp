...
const ViewBandejaDocumentosCoordinadorSecPitDos = () => {
  ...
  const agregar=async(e)=>{
    ...
    try {
        const nuevo={
          ...
          if(  await db.collection('endodictaminadoressecpitdos').add(nuevo)){
...
useEffect(() =>  {
  const obtenerDatos=async()=>{
      try {
          ...
          const data= await db.collection('endodocenteyasesorsecpitdos').orderBy('fecha','desc').get()
...
const eliminar=async(id)=>{
  try {
     await  db.collection('endodocenteyasesorsecpitdos').doc(id).delete()
...
export default ViewBandejaDocumentosCoordinadorSecPitDos