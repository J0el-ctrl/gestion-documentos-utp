...
const ViewBandejaDocumentosCoordinador = () => {
     ...
     const agregar=async(e)=>{
         ...
         try {
             const nuevo={
               ...
               if(  await db.collection('endodictaminadores').add(nuevo)){
    ...
    useEffect(() =>  {
        const obtenerDatos=async()=>{
            try {
                ...
                const data= await db.collection('endodocenteyasesor').orderBy('fecha','desc').get()
    ...
    const eliminar=async(id)=>{
        try {
           await  db.collection('endodocenteyasesor').doc(id).delete()
...
export default ViewBandejaDocumentosCoordinador