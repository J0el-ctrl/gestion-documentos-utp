...
const ViewBandejaDocumentosDictaminadoresUnoSecPitDos = () => {
...
const eliminar=async(id)=>{
  ...
  const agregar= async(e)=>{
   ...
   try {        
        ...
        if(await db.collection('endoresoluciondictaminadorunosecdos').add(nuevo)){
...
export default ViewBandejaDocumentosDictaminadoresUnoSecPitDos