...
const ViewBandejaDocumentosDictaminadores = () => {
...
const activarEdicion=(item)=>{
      ...
      const agregar= async(e)=>{
       ...
       try {        
            ...
            if(await db.collection('endoresoluciondictaminadoruno').add(nuevo)){
    ...
    <div>
      <div className="container text-enter bg-info mt-5">
        ...
        <div className="row">
            ...
            <p>Cantidad de documento: {docus.length}</p>
                ...
                <div className="table-responsive-md">
                    ...
                    <tbody>
                        <tr>
                            ...
                            {/* <td className="table-success">{item.fecha}</td> */}
...
export default ViewBandejaDocumentosDictaminadores